...
const OnlinePendaftaran = () => {
  return (
    <section>
      ...
      <Underline />
      <motion.p initial={animateFunc().initial} whileInView={animateFunc().animate} transition={animateFunc(0.8).transition} className="mt-8 mb-4 text-yellow-600 font-bold block max-w-lg rounded-md shadow-md py-2 text-center bg-slate-100">Coming Soon</motion.p>
    </section>
  );
};
